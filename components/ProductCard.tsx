  ...
  return (
    <Link href={`/product/${product._id}`} asChild>
      <TouchableOpacity style={{ width: '48%', marginBottom: 18 }}>
        <View style={{ width: '100%', aspectRatio: 1, borderRadius: 16, overflow: 'hidden', backgroundColor: '#F7F7F7', position: 'relative', borderWidth: 1, borderColor: '#eee' }}>
          {/* favourite icon */}
          <TouchableOpacity
          ...
          {/* is Featured */}
          {product.isFeatured && (
            <View style={{ position: 'absolute', top: 8, left: 8, zIndex: 15, backgroundColor: '#000', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6, opacity: 0.95 }}>
              <Text style={{ color: '#fff', fontSize: 11, fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: 1 }}>FEATURED</Text>
            </View>
          )}
          <Image
