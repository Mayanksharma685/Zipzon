  ...
  return (
    <View className='flex-row items-center justify-between px-4 py-3 bg-white'>
      ...
      <View className='flex-1 items-center justify-center'>
        {showLogo ? (
            <Image source = {require('../assets/logo.png')} style={{width: 100, height: 25}} resizeMode='contain'/>
            ) : title &&(
                <Text className='text-xl font-bold' style={{color: COLORS.primary}}>{title}</Text>
            )}
      </View>
